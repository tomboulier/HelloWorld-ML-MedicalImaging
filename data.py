...
class ImageGenerator(ImageDataGenerator):
    ...
    def build_from_directory(directory_path):
        ...
        return self.flow_from_directory(dataset.train_directory_path,
                                                    target_size=(self._dataset.img_height, self._dataset.img_width),
